...
gfxGbuffer* gfxCreateGbuffer(int width, int height)
{
	...
	gbuffer->depthTex = gfxCreate2dTexture(width, height, 0.0f, GFX_CLAMP, GFX_NEAREST, GFX_DEPTH_COMPONENT, GFX_DEPTH_COMPONENT, GFX_UBYTE, NULL);
	gbuffer->buf1Tex = gfxCreate2dTexture(width, height, 0.0f, GFX_CLAMP, GFX_NEAREST, GFX_RG, GFX_RG16F, GFX_FLOAT, NULL);
	gbuffer->buf2Tex = gfxCreate2dTexture(width, height, 0.0f, GFX_CLAMP, GFX_NEAREST, GFX_RGBA, GFX_RGBA, GFX_FLOAT, NULL);
	gbuffer->buf3Tex = gfxCreate2dTexture(width, height, 0.0f, GFX_CLAMP, GFX_NEAREST, GFX_RGBA, GFX_RGBA, GFX_FLOAT, NULL);
	gbuffer->diffuseTex = gfxCreate2dTexture(width, height, 0.0f, GFX_CLAMP, GFX_NEAREST, GFX_RGBA, GFX_RGBA16F, GFX_FLOAT, NULL);
	gbuffer->specularTex = gfxCreate2dTexture(width, height, 0.0f, GFX_CLAMP, GFX_NEAREST, GFX_RGBA, GFX_RGBA16F, GFX_FLOAT, NULL);
	gbuffer->mainTex = gfxCreate2dTexture(width, height, 0.0f, GFX_CLAMP, GFX_LINEAR, GFX_RGBA, GFX_RGBA, GFX_UBYTE, NULL);
