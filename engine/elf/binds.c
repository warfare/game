...
static int lua_GetKeyEventKey(lua_State *L)
{
	int result;
	elfKeyEvent* arg0;
	if(lua_gettop(L) != 1) {return lua_fail_arg_count(L, "GetKeyEventKey", lua_gettop(L), 1);}
	if(!lua_isuserdata(L, 1) || ((lua_elf_userdata*)lua_touserdata(L,1))->type != LUA_ELF_OBJECT ||
...
static int lua_GetKeyEventState(lua_State *L)
{
	int result;
	elfKeyEvent* arg0;
	if(lua_gettop(L) != 1) {return lua_fail_arg_count(L, "GetKeyEventState", lua_gettop(L), 1);}
	if(!lua_isuserdata(L, 1) || ((lua_elf_userdata*)lua_touserdata(L,1))->type != LUA_ELF_OBJECT ||
		elfGetObjectType(((lua_elfObject*)lua_touserdata(L, 1))->object) != ELF_KEY_EVENT)
...
static int lua_MulQuaVec3f(lua_State *L)
{
	...
	if(!lua_isuserdata(L, 1)) {return lua_fail_arg(L, "MulQuaVec3f", 1, "elfVec4f");}
	if(!lua_isuserdata(L, 2)) {return lua_fail_arg(L, "MulQuaVec3f", 2, "elfVec3f");}
...
static int lua_MulQuaQua(lua_State *L)
{
	...
	if(!lua_isuserdata(L, 1)) {return lua_fail_arg(L, "MulQuaQua", 1, "elfVec4f");}
	if(!lua_isuserdata(L, 2)) {return lua_fail_arg(L, "MulQuaQua", 2, "elfVec4f");}
	arg0 = ((lua_elfVec4f*)lua_touserdata(L, 1))->val;
...
static int lua_GetQuaInverted(lua_State *L)
{
	...
	if(!lua_isuserdata(L, 1)) {return lua_fail_arg(L, "GetQuaInverted", 1, "elfVec4f");}
	arg0 = ((lua_elfVec4f*)lua_touserdata(L, 1))->val;
...
static int lua_SetLightRange(lua_State *L)
{
	...
	float arg1;
	float arg2;
	if(lua_gettop(L) != 3) {return lua_fail_arg_count(L, "SetLightRange", lua_gettop(L), 3);}
	if(!lua_isuserdata(L, 1) || ((lua_elf_userdata*)lua_touserdata(L,1))->type != LUA_ELF_OBJECT ||
		elfGetObjectType(((lua_elfObject*)lua_touserdata(L, 1))->object) != ELF_LIGHT)
		{return lua_fail_arg(L, "SetLightRange", 1, "elfLight");}
	if(!lua_isnumber(L, 2)) {return lua_fail_arg(L, "SetLightRange", 2, "number");}
	if(!lua_isnumber(L, 3)) {return lua_fail_arg(L, "SetLightRange", 3, "number");}
	arg0 = (elfLight*)((lua_elfObject*)lua_touserdata(L, 1))->object;
	arg1 = (float)lua_tonumber(L, 2);
	arg2 = (float)lua_tonumber(L, 3);
...
static int lua_GetLightFadeRange(lua_State *L)
{
	float result;
	elfLight* arg0;
	if(lua_gettop(L) != 1) {return lua_fail_arg_count(L, "GetLightFadeRange", lua_gettop(L), 1);}
	if(!lua_isuserdata(L, 1) || ((lua_elf_userdata*)lua_touserdata(L,1))->type != LUA_ELF_OBJECT ||
		elfGetObjectType(((lua_elfObject*)lua_touserdata(L, 1))->object) != ELF_LIGHT)
...
static int lua_GetLightInnerCone(lua_State *L)
{
	float result;
	elfLight* arg0;
	if(lua_gettop(L) != 1) {return lua_fail_arg_count(L, "GetLightInnerCone", lua_gettop(L), 1);}
	if(!lua_isuserdata(L, 1) || ((lua_elf_userdata*)lua_touserdata(L,1))->type != LUA_ELF_OBJECT ||
		elfGetObjectType(((lua_elfObject*)lua_touserdata(L, 1))->object) != ELF_LIGHT)
...
static int lua_GetLightOuterCone(lua_State *L)
{
	float result;
	elfLight* arg0;
	if(lua_gettop(L) != 1) {return lua_fail_arg_count(L, "GetLightOuterCone", lua_gettop(L), 1);}
	if(!lua_isuserdata(L, 1) || ((lua_elf_userdata*)lua_touserdata(L,1))->type != LUA_ELF_OBJECT ||
		elfGetObjectType(((lua_elfObject*)lua_touserdata(L, 1))->object) != ELF_LIGHT)
